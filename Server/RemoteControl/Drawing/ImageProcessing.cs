...
namespace RemoteControl.Drawing
{
    public class ImageProcessing
    {
        ...
        public static Image CutForSquare(Image img, Point p , int width , int height)
        {
            ...
            else
            {
                ...
                pickedG.InterpolationMode = System.Drawing.Drawing2D.InterpolationMode.Default;
                pickedG.SmoothingMode = System.Drawing.Drawing2D.SmoothingMode.Default;
                Rectangle fromR = new Rectangle(p.X, p.Y, width, height);
        ...
        public static byte[] CompressedImageQuality(Image img,long quality)
        {
            try
            {
                EncoderParameter p;
                ...
                img.Save(ms, GetCodecInfo("image/jpeg"), ps);
                return ms.GetBuffer();
            }
            catch
            {
